...
#ifndef max_lowpassFXParams_H
#define max_lowpassFXParams_H
...
static const AkPluginParamID PARAM_FREQ_ID = 0;
static const AkUInt32 NUM_PARAMS = 1;

struct max_lowpassRTPCParams
{
    AkReal32 freq;
};

struct max_lowpassNonRTPCParams
{
};

struct max_lowpassFXParams
    : public AK::IAkPluginParam
{
    max_lowpassFXParams();
    max_lowpassFXParams(const max_lowpassFXParams& in_rParams);
    ...
    max_lowpassRTPCParams RTPC;
    max_lowpassNonRTPCParams NonRTPC;
};

#endif // max_lowpassFXParams_H
